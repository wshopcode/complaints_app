...
<html lang="en">
    ...
    <link rel="stylesheet" href="/frontend/css/bootstrap-reboot.min.css" type="text/css">
        ...
        <title>Complaints App - Search</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="coverpage.html">ODPP COMPLAINTS APP <small class="text-muted">web app</small></a>
        ...
        <form method="post" action="index4.php">
          <div class="form-group">
            <label for="dppfilenumber">Please type in the ODPP file number below and click search button below:</label>
          ...
          <button type="submit" name="dppfilenumber" class="btn btn-primary btn-block" value="submit">Click here to search</button>
          <br>
          <!-- <a href="feedback.php" button type="button" name="feedback" class="btn btn-secondary btn-block">Click here to contact us</button></a> -->
        </form>
        <br>
